...
public class SeleccionRecursivoTest{
    private SeleccionRecursivo seleccion;
    public SeleccionRecursivoTest()
    {
    }
    @BeforeEach
    public void setUp()
    {
        seleccion = new SeleccionRecursivo();
    }
    @Test
    public void prueba1(){
      int [] arreglo = {4,5,1,2,3}; 
      int [] respEsp = {1,2,3,4,5};
      int [] resp = seleccion.seleccion(arreglo);
