...
public class BurbujaRecursivoTest{
    private BurbujaRecursivo burbuja;
    public BurbujaRecursivoTest()
    {
    }
    @BeforeEach
    public void setUp()
    {
        burbuja = new BurbujaRecursivo();
    }
    @Test
    public void prueba1(){
      int [] arreglo = {4,5,1,2,3}; 
      int [] respEsp = {1,2,3,4,5};
      int [] resp = burbuja.burbuja(arreglo);
